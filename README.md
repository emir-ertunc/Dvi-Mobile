...
- Uygulama içinde görünür build kimliği: `phase-3a-v0.3.0-20260511`
...
Android APK GitHub Actions üzerinde `Phase 3A APK` workflow'u ile üretilir. Beklenen artifact adı:

```text
DviMobile-phase-3a-v0.3.0-20260511.apk
```
