...
- Uygulama sürümü: `0.1.8`
- Uygulama içinde görünür build kimliği: `phase-1d-v0.1.8-20260510`
...
Android APK GitHub Actions üzerinde `Phase 1D APK` workflow'u ile üretilir. Beklenen artifact adı:

```text
DviMobile-phase-1d-v0.1.8-20260510.apk
```
